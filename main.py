...
app_label = Label(frame_tela, textvariable=valor_texto, width=16, height=2, padx=7, relief=FLAT, anchor ="e", justify= RIGHT, font=('Ivy 18 '), bg=cor2, fg=cor4)
...
b_2.place(x=118,y=0)
b_3 = Button(frame_corpo,  command=lambda: entrar_valores('/'),text="/", width=5, height=2, bg=cor3, fg=cor5, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_3.place(x=177,y=0)
...
b_7 = Button(frame_corpo,  command=lambda: entrar_valores('*'),text="*", width=5, height=2, bg=cor3, fg=cor5, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_11 = Button(frame_corpo,  command=lambda: entrar_valores('-'),text="-", width=5, height=2, bg=cor3, fg=cor5, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_15 = Button(frame_corpo,  command=lambda: entrar_valores('+'),text="+", width=5, height=2, bg=cor3, fg=cor5, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_18 = Button(frame_corpo, command=calcular, text="=", width=5, height=2, bg=cor3, fg=cor5, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
